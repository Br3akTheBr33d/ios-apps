...
function renderWorkspaceDetail() {
  ...
  c.innerHTML = ws.collections.map((col, ci) => {
    return '<div class="collection-card" data-collection-id="' + col.id + '"><div class="collection-header"><div><div class="collection-title">' + escapeHtml(col.name) + '</div>' + (col.notes ? '<div class="collection-notes">' + escapeHtml(col.notes) + '</div>' : '') + '</div><div class="collection-actions"><button class="btn-icon collection-info" data-collection-id="' + col.id + '" title="Info"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg></button><button class="btn-icon collection-add-note" data-collection-id="' + col.id + '" title="Notiz"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg></button><button class="btn-icon collection-open-all" data-collection-id="' + col.id + '" title="Alle öffnen"' + (!col.tabs?.length ? ' disabled' : '') + '><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></button><button class="btn-icon collection-add-tab" data-collection-id="' + col.id + '" title="Tab hinzufügen"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg></button><button class="btn-icon collection-edit" data-collection-index="' + ci + '" title="Bearbeiten"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button></div></div>' + (col.stickyNotes?.length ? '<div class="sticky-notes-section">' + col.stickyNotes.map((n, ni) => '<div class="sticky-note" style="background: ' + (n.color || '#feca57') + '"><div class="sticky-note-content">' + escapeHtml(n.content) + '</div><div class="sticky-note-actions"><button class="sticky-note-edit" data-note-index="' + ni + '" data-collection-id="' + col.id + '" title="Bearbeiten"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></button><button class="sticky-note-delete" data-note-index="' + ni + '" data-collection-id="' + col.id + '" title="Löschen"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button></div></div>').join('') + '</div>' : '') + '<div class="collection-tabs">' + (col.tabs?.length ? col.tabs.map((t, ti) => '<div class="collection-tab" data-tab-url="' + escapeHtml(t.url) + '" data-collection-id="' + col.id + '" data-tab-index="' + ti + '"><img src="' + (t.favIconUrl || getFaviconUrl(t.url)) + '" class="collection-tab-favicon" onerror="this.style.display=\'none\'"><div class="collection-tab-content"><div class="collection-tab-title">' + escapeHtml(t.title) + '</div><div class="collection-tab-url">' + escapeHtml(t.url) + '</div>' + (t.notes ? '<div class="collection-tab-notes">' + escapeHtml(t.notes) + '</div>' : '') + '</div><div class="collection-tab-actions"><button class="btn-icon tab-open" data-tab-url="' + escapeHtml(t.url) + '" title="Öffnen"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></button><button class="btn-icon tab-edit" data-collection-id="' + col.id + '" data-tab-index="' + ti + '" title="Bearbeiten"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></button></div></div>').join('') : '<div class="no-tabs-message">Keine Tabs - klicke + um hinzuzufügen</div>') + '</div></div>';
  }).join('');
  ...
  c.querySelectorAll('.collection-tab').forEach(el => {
    ...
    // mouseenter/mouseleave entfernt — Tab-Vorschau auf iOS-Touch nicht sinnvoll
  });
